...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset('nice-admin') }}/assets/img/rnd.png" rel="icon">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="{{ asset('nice-admin') }}/index.html" class="logo d-flex align-items-center">
        <img src="{{ asset('nice-admin') }}/assets/img/rnd.png" alt="">
        <div class="d-flex flex-column">
            <span class="d-none d-lg-block">panel engineer</span>
            <div style="font-size: 8pt; margin-bottom: 5px">make involved & collaborated</div>
        </div>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-heading">Product Maintain</li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ asset('nice-admin') }}/index.html">Home</a></li>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Product Release <span>| Weekly</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
              ...
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Issue & Case <span>| Weekly</span></h5>
  ...
  <footer id="footer" class="footer">
    <div class="copyright" style="text-align: left; margin-left: 28px">
      Copyright 2024 &copy; Panel Engineer. All right reserved.
    </div>
  </footer><!-- End Footer -->
